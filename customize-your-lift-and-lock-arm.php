...
<script>
   ...
   function clearselected(x){
   	...
   	if(t==1){
   		...
   		document.getElementById("items10").textContent= "Single Bone"
   		document.getElementById("tr10a").textContent="8225"
   		document.getElementById("items10num").textContent="8225"
   	}
   	else if(t==80){
   		document.getElementById("items10").textContent= "Lift Shaft"
   		document.getElementById("tr10a").textContent="8515"
   		document.getElementById("items10num").textContent="8515"
   	}
   	else if(t==81){
   		document.getElementById("items10").textContent= "Click Riser"
   		document.getElementById("tr10a").textContent="N/A"
   		document.getElementById("items10num").textContent="N/A"
   	}
   	else if(t==82){
   		document.getElementById("items10").textContent= "M2 Riser"
   		document.getElementById("tr10a").textContent="N/A"
   		document.getElementById("items10num").textContent="N/A"
   	}
   	else if(t==83){
   		document.getElementById("items10").textContent= "M2X Riser"
   		document.getElementById("tr10a").textContent="N/A"
   		document.getElementById("items10num").textContent="N/A"
   	}
   	else if(t==84){
   		document.getElementById("items10").textContent= "M2 Max Riser"
   		document.getElementById("tr10a").textContent="N/A"
   		document.getElementById("items10num").textContent="N/A"
   	}
   	else if(t==85){
   		document.getElementById("items10").textContent= "Lift and Lock Head"
   		document.getElementById("tr10a").textContent="N/A"
   		document.getElementById("items10num").textContent="N/A"
   	}
   	else if(t==86){
   		document.getElementById("items10").textContent= "Lift and Lock Tail"
   		document.getElementById("tr10a").textContent="N/A"
   		document.getElementById("items10num").textContent="N/A"
   	}
   	else{
...
<div class="everythingelse" id="everythingelse">
 <div id="frame" class="frame" style="left:50%; height:740px; width:1200px; z-index:-5;"><img id="framepic" style="height:746px; margin-top:-6px; margin-left:0px;" src="powerchair renderings/slider-frame.png" /></div>
   <div id="overall" style="height:715px; width:1180px; left:50%; margin-left:-577px; position:absolute; overflow:hidden; margin-top:200px;">
